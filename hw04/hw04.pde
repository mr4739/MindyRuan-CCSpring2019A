...
alternating directions and colors with lines connecting 
to center. Colors change based on mouseX and mouseY values.
...
// Draws ring of squares with lines connecting them to center
